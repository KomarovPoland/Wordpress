...
function initMap() {
    ...
    const icon_image = "/wp-content/uploads/2021/10/marker-image.png"
    const icon_image_red = "/wp-content/uploads/2021/10/marker-image-red.png"
        ...
        <script>
            ...
            function initMap(count = '') {
                ...
                if (div_arr.length == 0) {
                    ...
                    const icon_image = '/wp-content/uploads/2021/10/marker-image.png';//картинка иконки адреса
                    const icon_image_red = '/wp-content/uploads/2021/10/marker-image-red.png';//картинка иконки адреса
...
function fn_getBrokerData()
{
    ...
    $nameArray = explode(' ',trim($postBroker->post_title));
    $last = count($nameArray)-1;
    $nameArray[$last]=$nameArray[$last]."'s";
    $nameOfBroker = '';
    for($i=0; $i<count($nameArray);$i++){
        $nameOfBroker .= $nameArray[$i].' ';
    }
        ...
        <div class="block-overflow">
            ...
            <div class="row broker-page-bottom container mx-sm-0 px-sm-0 mx-md-2 px-md-2">
                <div class=" col-12 mb-4 mb-md-2">
                    ...
                    ' . $nameOfBroker .' Current Listings</span>
