...
<main class="container-fluid mx-auto bg-white main-box ">
    <div class="container mt-2">
        <div class="row mt-1">
            <a href="<?php echo home_url(); ?>/#home_properties" class="col-12 d-flex justify-content-start align-items-center py-3">
