        ...
        <div class="container our-team">
            <div class="row-box row d-flex justify-content-start mx-2">
                ...
                foreach ($query_posts as $post_data) {
                    ...
                    $the_image_default = wp_get_attachment_image_url($post_data->broker_image, 'large');
                    $the_image_team = wp_get_attachment_image_url(get_post_thumbnail_id($post_data->ID), 'large');

                    $the_image = $the_image_team ? $the_image_team : $the_image_default;
                 ...
                 <div class="col-12 col-md-4 my-3  my-md-3 ">
                    <div class="col-12 d-flex flex-column justify-content-start align-items-start" style="min-height: 100%;">
                        ...
                        <div class="broker-information">
                         ...
                         <p class="team-broker-phone">' . $post_data->employee_position . '</p>
